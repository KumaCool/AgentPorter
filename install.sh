...
REQUIRED_MODULES='agentporter.activation_application agentporter.activation_entry agentporter.bootstrap_txn agentporter.dispatch_application agentporter.dispatch_planning agentporter.hermes_runtime agentporter.legacy_migration agentporter.kanban_runtime agentporter.readiness agentporter.runtime_authority agentporter.runtime_binding agentporter.runtime_observation agentporter.runtime_probe agentporter.plan06_role_bindings agentporter.role_identity_compat agentporter.role_name_migration agentporter.role_name_migration_application'
