...
- 当前 Phase 1–4 已实现一次性安装、静态读回、有限补偿，以及名称无关发现、绑定确认、集合/逐项重验和独立原生卸载；并已在临时 `HOME`/`HERMES_HOME` 中通过 Hermes v0.20 的双 Profile 安装、批量改名、读回、故障补偿和安全卸载演练。Phase 5 完整真实验收和 Phase 6 发布仍未完成。
