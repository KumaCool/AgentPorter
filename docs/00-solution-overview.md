...
- 当前 Phase 1–5 已实现一次性安装、静态读回、有限补偿、名称无关独立卸载，以及正式入口、资源、规模和故障验收；并已在隔离临时 `HOME`/`HERMES_HOME` 中通过 Hermes v0.20 的双 Profile 安装、批量改名、读回、故障补偿和安全卸载演练。Phase 6 开源产品化和最终发布门禁仍未完成。
