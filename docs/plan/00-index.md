...
| 04 | [Runtime Readiness 与编排闭环落地计划](04-runtime-readiness-closure-implementation.md) | Phase A-D 已完成离线闭环；Hermes v0.20 真实 probe 不受支持；Phase E 进行中 | 实现可重放运行绑定、安全 canary、专用 orchestrator、任务订阅读回、派发收据、运行观察与发布闭环 |
